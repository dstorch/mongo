...
namespace mongo {
    ...
    /**
     * Attempt to kill a list of cursor ids. The ClientCursors will be removed from the
     * CursorManager and destroyed.
     */
    ...
    public:
        ...
        /**
         * A killCursors command does not increment the command counter, but rather increments a
         * separate kill cursors counter.
         */
        ...
        bool run(OperationContext* txn,
            ...
            if (killCursorsRequest.nss.coll().startsWith("$cmd")) {
                cursorManager = CursorManager::getGlobalCursorManager();
            }
            else {
                ctx.reset(new AutoGetCollectionForRead(txn, killCursorsRequest.nss));
