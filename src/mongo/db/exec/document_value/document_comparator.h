...
public:
    ...
    int compare(const Document& lhs, const Document& rhs) const {
        return Document::compare(lhs, rhs, _stringComparator, _comparisonRulesSet);
    }
    ...
    size_t hash(const Document& doc) const {
        // TODO: Hashing needs to respect '_comparisonRulesSet'.
...
private:
    ...
    Document::ComparisonRulesSet _comparisonRulesSet = 0u;
};
