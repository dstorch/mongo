...
void RequiresCollectionStage::doSaveState() {
    // The collection pointer may not remain valid for the duration of this query's execution; e.g.
    // if the collection gets renamed.
    _collection = nullptr;

    doRequiresCollectionStageSaveState();
}
...
void RequiresCollectionStage::doRestoreState() {
    ...
    doRequiresCollectionStageRestoreState();
}
