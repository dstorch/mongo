...
public:
    ...
    /**
     * Returns an id referring to the next WorkingSetMember the sorted stream of results.
     *
...
public:
    static constexpr StringData kStageType = "SORT_DEFAULT"_sd;
 ...
 * refer to the record in storage in order to perform a write).
 */
class SortStageSimple final : public SortStage {
public:
    static constexpr StringData kStageType = "SORT_SIMPLE"_sd;
