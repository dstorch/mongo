...
TEST(CollatorInterfaceICUTest, ASCIIComparisonWorksForUSEnglishCollation) {
    ...
    ASSERT_LT(icuCollator.compare(StringData("ab"), StringData("ba")), 0);
    ASSERT_GT(icuCollator.compare(StringData("ba"), StringData("ab")), 0);
    ASSERT_EQ(icuCollator.compare(StringData("ab"), StringData("ab")), 0);
}
