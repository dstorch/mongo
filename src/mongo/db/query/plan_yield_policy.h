...
public:
     ...
     *
     * The 'yieldable' interface can be used to cause the PlanYieldPolicy to save and restore an
     * arbtriary object.
     */
...
private:
    ...
    /**
     * Relinquishes and reacquires lock manager locks. Also responsible for checking interrupt
     * during yield and calling 'abandonSnapshot()' to relinquish the query's storage engine
     * snapshot.
     */
