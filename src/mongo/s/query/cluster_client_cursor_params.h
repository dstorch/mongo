...
namespace mongo {
    ...
    struct ClusterClientCursorParams {
        ...
        ClusterClientCursorParams(const std::string& fullns) : nsString(fullns) { }
        ...
        // The number of results per batch. Optional. If specified, will be specified as the batch for each
        // getMore.
