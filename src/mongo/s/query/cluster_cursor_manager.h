...
public:
    ...
    public:
        ...
        /**
         * Returns whether or not the pinned ClusterClientCursor is tailing a capped collection.
         * Cannot be called after returnCursor() is called.  A cursor must be owned.
         */
