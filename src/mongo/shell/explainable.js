...
let Explain = (function() {
     ...
     * presents this information in a more consumable format. Rather than an object, this function
     * returns an array of information about each candidate plan. The first element of the array is
     * always the winning plan. Each of the plans is represented by an object with the following
     * schema:
     *
     *  {
     *    planNumber: <number>,
     ...
     */
    function reformatExperimental(explain, fieldsToKeep) {
        const kCommonStats = [
            "advances",
            "opens",
            "closes",
        ...
        function doReformatting(queryPlanner, executionStats, fieldsToKeep) {
            ...
            for (let plan of rejectedPlans) {
                if (!rejectedPlans.hasOwnProperty("slotBasedPlan")) {
    ...
    function help() {
        print(
            `
Explain.reformatExperimental(<explain>, <projection>)

\tExperimental helper which takes explain output  and presents it in a more consumable fashion.
\tReturns an array of plans where each plan has the following schema:
...
\t<projection> - an optional array of field names to include for each candidate plan
`);
        return __magicNoPrint;
    };
    ...
    return {
        help: help,
        reformatExperimental: reformatExperimental,
    };
})();
