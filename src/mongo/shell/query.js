...
DBQuery.prototype._convertToCommand = function(canAttachReadPref) {
    ...
    if (canAttachReadPref) {
        // If there is a readPreference, use the wrapped command form. If there is no read
        // preference, but there is a slaveOk, convert to secondaryPreferred read preference.
